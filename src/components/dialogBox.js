      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-description">
            ...
            <br />
            <b>
              "Hey, I'm not sure where Tony is, but you can try this number,
              they might know where he's been.
              <br />
              (907) 555-4323"
            </b>
            <br />
            <br />
            Your goal, text this number to find out where Tony was last seen.
            <br />
            <br />
            When you finish with the story, press the <IoMdArrowRoundBack />{" "}
            button on the top right of the window to send me your conversation!
            It will help me with further development.
            <br />
            <br />
            Press the <IoMdInformationCircleOutline /> at any point to come back
            to these directions. Thanks! Enjoy!
          </DialogContentText>
        </DialogContent>
        <DialogActions>
          <Button
